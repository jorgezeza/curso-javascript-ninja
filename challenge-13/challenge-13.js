(function() {
    ...
    */
    ...
    var sudeste = ['Espírito Santo','Minas Gerais','São Paulo'];
    ...
    */
    var nordeste = ['Ceará','Bahia','Maranhão'];
   ...
   var seven = brasil.every(function(item){
    ...
    // ?
    console.log(seven ? 'Sim, todos os estados tem mais de 7 letras!' :
                        'Nem todos os estados tem mais de 7 letras!' );
    ...
    */
    ...
    // ?
    console.log(existCeara ? 'Ceará está incluído!' :
                             'Ceará não foi incluído');
    /*
