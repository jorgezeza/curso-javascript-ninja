( function(){
    ...
    */
    ...
    operador passado para a função "calculator", e 
     para esse método
    ...
    */
    operationSignal = '+';
    var sun = calculator( operationSignal );
    ...
    */
    if( sun ) {
        number1 = 10;
        number2 = 20;
        console.log( showOperationMessage(operationSignal, number1, number2), sun(number1, number2) )
    } else {
